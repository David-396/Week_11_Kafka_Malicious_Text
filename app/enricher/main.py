...
if __name__ == '__main__':
    ...
    enricher = EnricherManager(weapon_list_file_path=WEAPON_LIST_FILE_PATH, topic_mapping=topic_mapping, topics_list=topics_list)

    while True:
        try:

            enricher.consume_process_produce(group_id='group-1')
